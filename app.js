...
let favFood = ["taco", "pizza", "cheeseburger"]

let secondFoods = favFood[0]
...
let moreFoods = ['taco','pizza', ...foods, 'cheeseburger']
...
let removedFoods = foods.splice(2, 'sushi', 'cupcake')
...
let yummy = foods.slice(1, 3) // ['sushi, 'cupcake']
